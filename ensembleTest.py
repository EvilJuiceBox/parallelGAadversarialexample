...
def main(args):
    ...
    while total < 30:
        ...
        if groundtruth == basemodelprediction and groundtruth == ensemblemodelprediction:
            ...
            imgTitle = "./higherAccuracy08232021/" + str(imgTitle) + str(DeepNeuralNetworkUtil.getClassLabel(failedpred)) + ".png"
            ...
            imgTitle = "./higherAccuracy08232021/" + str(imgTitle) + str(
    ...
    pickle_out = open("./higherAccuracy08232021/regularmodelresults.pickle", "wb")
    pickle.dump(collection, pickle_out)
    pickle_out.close()

    pickle_out = open("./higherAccuracy08232021/ensemblemodelresult.pickle", "wb")
