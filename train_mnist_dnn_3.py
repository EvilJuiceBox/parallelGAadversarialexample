...
def main(args):
    ...
    from keras.layers import Concatenate, Conv2D, Dense, Dropout, Flatten, Input, MaxPooling2D
    ...
    x1 = Conv2D(32, kernel_size=(3, 3), activation='relu')(inputs)
    x1 = MaxPooling2D(pool_size=(2, 2))(x1)
    x1 = Conv2D(64, kernel_size=(3, 3), activation='relu')(x1)
    x1 = MaxPooling2D(pool_size=(2, 2))(x1)
    x1 = Flatten()(x1)
    x1 = Dropout(0.5)(x1)
    x1 = Dense(num_classes, activation='relu')(x1)

    x2 = Conv2D(32, kernel_size=(3, 3), activation='relu')(inputs)
    ...
    x2 = Flatten()(x2)
    x2 = Dropout(0.5)(x2)
    x2 = Dense(num_classes, activation='relu')(x2)
